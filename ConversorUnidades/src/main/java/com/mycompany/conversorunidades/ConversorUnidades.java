...
import java.util.Scanner;
    ...
    public static double converterTemperatura(double valor, String unidadeOrigem, String unidadeDestino) {
        ...
        if (unidadeOrigem.equalsIgnoreCase("C") && unidadeDestino.equalsIgnoreCase("F")) {
            ...
            throw new IllegalArgumentException("Unidades de temperatura incorretas!");
        }
    }
    ...
    public static double converterDistancia(double valor, String unidadeOrigem, String unidadeDestino) {
        if (unidadeOrigem.equalsIgnoreCase("m") && unidadeDestino.equalsIgnoreCase("km")) {
            ...
            throw new IllegalArgumentException("Unidades de distância incorretas!");
        }
    }
    ...
    public static double converterPeso(double valor, String unidadeOrigem, String unidadeDestino) {
        if (unidadeOrigem.equalsIgnoreCase("g") && unidadeDestino.equalsIgnoreCase("kg")) {
            ...
            throw new IllegalArgumentException("Unidades de peso incorretas!");
        }
    }
    ...
    public static double converterTempo(double valor, String unidadeOrigem, String unidadeDestino) {
        if (unidadeOrigem.equalsIgnoreCase("s") && unidadeDestino.equalsIgnoreCase("min")) {
            ...
            throw new IllegalArgumentException("Unidades de tempo incorretas!");
        }
    }
    ...
    public static double converterVelocidade(double valor, String unidadeOrigem, String unidadeDestino) {
        ...
        } else if (unidadeOrigem.equalsIgnoreCase("m/s") && unidadeDestino.equalsIgnoreCase("mph")) {
        ...
        } else if (unidadeOrigem.equalsIgnoreCase("km/h") && unidadeDestino.equalsIgnoreCase("mph")) {
        ...
        } else if (unidadeOrigem.equalsIgnoreCase("mph") && unidadeDestino.equalsIgnoreCase("m/s")) {
            return valor * 0.44704; // Milhas por Hora para Metros por Segundo
            
        } else if (unidadeOrigem.equalsIgnoreCase("mph") && unidadeDestino.equalsIgnoreCase("km/h")) {
            return valor / 0.621371; // Milhas por Hora para Quilômetros por Hora
            
        } else if (unidadeOrigem.equalsIgnoreCase("mph") && unidadeDestino.equalsIgnoreCase("kn")) {
        ...
        } else if (unidadeOrigem.equalsIgnoreCase("kn") && unidadeDestino.equalsIgnoreCase("mph")) {
            return valor / 0.868976; // Nós para Milhas por Hora
            
        } else {
            throw new IllegalArgumentException("Unidades de velocidade incorretas!");
        }
    }

    // Conversão de Área  m/quadrado | k/quadrado | ha | ac
    public static double converterArea(double valor, String unidadeOrigem, String unidadeDestino) {
        if (unidadeOrigem.equalsIgnoreCase("m/quadrado") && unidadeDestino.equalsIgnoreCase("k/quadrado")) {
            return valor / 1000000; // Metros Quadrados para Quilômetros Quadrados
            
        } else if (unidadeOrigem.equalsIgnoreCase("m/quadrado") && unidadeDestino.equalsIgnoreCase("ha")) {
            return valor / 10000; // Metros Quadrados para Hectares
            
        } else if (unidadeOrigem.equalsIgnoreCase("m/quadrado") && unidadeDestino.equalsIgnoreCase("ac")) {
            return valor / 4046.86; // Metros Quadrados para Acres
            
        } else if (unidadeOrigem.equalsIgnoreCase("k/quadrado") && unidadeDestino.equalsIgnoreCase("m/quadrado")) {
            return valor * 1000000; // Quilômetros Quadrados para Metros Quadrados
            
        } else if (unidadeOrigem.equalsIgnoreCase("k/quadrado") && unidadeDestino.equalsIgnoreCase("ha")) {
            return valor * 100; // Quilômetros Quadrados para Hectares
            
        } else if (unidadeOrigem.equalsIgnoreCase("k/quadrado") && unidadeDestino.equalsIgnoreCase("ac")) {
            return valor * 247.105; // Quilômetros Quadrados para Acres
            
        } else if (unidadeOrigem.equalsIgnoreCase("ha") && unidadeDestino.equalsIgnoreCase("m/quadrado")) {
            return valor * 10000; // Hectares para Metros Quadrados
            
        } else if (unidadeOrigem.equalsIgnoreCase("ha") && unidadeDestino.equalsIgnoreCase("k/quadrado")) {
        ...
        } else if (unidadeOrigem.equalsIgnoreCase("ac") && unidadeDestino.equalsIgnoreCase("m/quadrado")) {
            return valor * 4046.86; // Acres para Metros Quadrados
            
        } else if (unidadeOrigem.equalsIgnoreCase("ac") && unidadeDestino.equalsIgnoreCase("k/quadrado")) {
            ...
            throw new IllegalArgumentException("Unidades de área incorretas!");
        }
    }
